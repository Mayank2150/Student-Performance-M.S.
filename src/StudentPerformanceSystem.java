...
public class StudentPerformanceSystem {
    ...
    // Set font size for table headers
        ...
        tableHeader.setFont(new Font("Arial", Font.BOLD, 20)); // Increase header font size

    // Set font size for table rows
        table.setFont(new Font("Arial", Font.PLAIN, 20)); // Increase row font size
        table.setRowHeight(25); // Adjust row height to accommodate larger font
